...
date: "RIVER RUN 9,  Date: 10/07/24-10/11/24"
output:
...
knitr::opts_chunk$set(fig.width=18, fig.height=20, fig.path='Figs/rr9/',
...
For river run 9 (October 07 2024 to October 11 2024): there were 150 planned tows; no sample sites were affected by low D.O. (\>4.5 mg/l) or high Temp (\>28°C). 150 valid samples were collected.

-   No sturgeon were caught.

-   No Round Goby were caught.

-   30 Blue Crabs were caught.

-   Heavy ctenophores caught in beam trawls in regions 1 and 2.
...
lc.df <- read_sas("E:/SBU/research/Lab/HRBMP/Bi-weekly report 2024/Data/river run 9/fs24c1_09.sas7bdat")

# fs20lw1.sas7bdat – lab length and weight data sheet
lw.lab.df <- read_sas("E:/SBU/research/Lab/HRBMP/Bi-weekly report 2024/Data/river run 9/fs24lw1_09.sas7bdat")

#  fs20m1.sas7bdat – sturgeon data sheet
stur.df <- read_sas("E:/SBU/research/Lab/HRBMP/Bi-weekly report 2024/Data/river run 9/fs24m1_09.sas7bdat")

# fs20q1.sas7bdat – water quality data (this will be a little different , adding turbidity)
wq.df <- read_sas("E:/SBU/research/Lab/HRBMP/Bi-weekly report 2024/Data/river run 9/fs24q1_09.sas7bdat")

# fs20r1.sas7bdat – Number of samples returned to lab
nlab.df <- read_sas("E:/SBU/research/Lab/HRBMP/Bi-weekly report 2024/Data/river run 9/fs24r1_09.sas7bdat")

# fs20s1.sas7bdat – Field Header information
header.df <- read_sas("E:/SBU/research/Lab/HRBMP/Bi-weekly report 2024/Data/river run 9/fs24s1_09.sas7bdat")

# fs20cl1.sas7bdat – ?
#test <- read_sas("Data/river run 1/fs24cl1_01.sas7bdat")

# other information needed
region.df <- read.csv("E:/SBU/research/Lab/HRBMP/Bi-weekly report 2024/Data/region.rm.csv") # river.region
  species.df <- read.csv("E:/SBU/research/Lab/HRBMP/Bi-weekly report 2024/Data/species.code.csv") # species list
...
```{r}
knitr::opts_chunk$set(fig.width=18, fig.height=15, fig.path='Figs/rr9/',
                      echo=FALSE, warning=FALSE, message=FALSE)
```
...
```{r}
knitr::opts_chunk$set(fig.width=12, fig.height=7, fig.path='Figs/rr9/',
                      echo=FALSE, warning=FALSE, message=FALSE)
```
...
```{r}
knitr::opts_chunk$set(fig.width=15, fig.height=15, fig.path='Figs/rr9/',
                      echo=FALSE, warning=FALSE, message=FALSE)
```
...
rg.df <- read_excel("E:/SBU/research/Lab/HRBMP/Bi-weekly report 2024/Data/river run 5/2024 Hudson River FJS Sturgeon and Round Goby Tables.xlsx", sheet = 2)
